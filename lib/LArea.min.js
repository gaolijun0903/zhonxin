window.LArea = function() {
    ...
    return e.prototype = {
        ...
        getData: function(e) {
            var t = this;
            if ("object" == typeof t.params.data)
                t.data = t.params.data,
                    e();
            else {
        ...
        bindEvent: function() {
            ...
            function t() {
                switch (d.gearArea.querySelector(".area_province").setAttribute("val", d.value[0]),
                    d.gearArea.querySelector(".area_city").setAttribute("val", d.value[1]),
                    d.gearArea.querySelector(".area_county").setAttribute("val", d.value[2]),
                    d.type) {
                    case 1:
        ...
        setGearTooth: function(e) {
            var t = this
                ...
                , s = r - 1;
            if (n > s && (n = s),
                    i[t.index].setAttribute("data-len", r),
                r > 0) {
                ...
                for (var l = "", v = 0; r > v; v++)
                    l += "<div class='tooth'  ref='" + a[v][this.keys.id] + "'>" + a[v][this.keys.name] + "</div>";
                if (i[t.index].innerHTML = l,
                        i[t.index].style["-webkit-transform"] = "translate3d(0," + 2 * -n + "em,0)",
                ...
                1 == t.index && (i[2].innerHTML = "<div class='tooth'></div>",
